...
Design the landing page for Huddle. The landing page features several unique elements
to test basic HTML and CSS skills. The page features a stylistic background, alongside a
button to register for the service.
